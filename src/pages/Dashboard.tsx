  ...
  const categories = [
    {
      ...
      items: [
        ...
        { title: 'Exchange Flows', value: '-$1.2B', change: 'Outflow', icon: ArrowRightLeft, color: 'text-green-400', bg: 'bg-green-400/10' },
      ]
    },
    {
      title: 'Indicators',
    ...
    },
    {
      ...
      items: [
        ...
        { title: 'MACD', value: 'Signal Cross', change: 'Buy', icon: TrendingUp, color: 'text-green-400', bg: 'bg-green-400/10' },
      ]
    },
    {
      title: 'Derivatives',
          ...
          <section key={idx} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {category.items.map((item, i) => {
                ...
                if (isPositiveChange) {
                  changeBadgeClass = 'text-green-400 bg-green-400/10 border border-green-400/20';
                } else if (isNegativeChange) {
                  changeBadgeClass = 'text-red-400 bg-red-400/10 border border-red-400/20';
                }
